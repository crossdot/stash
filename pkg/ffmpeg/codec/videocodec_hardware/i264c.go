...
func (c *Codec_hardware_i264c) HwApplyFullHWFilter(args ffmpeg.VideoFilter, fullhw bool) ffmpeg.VideoFilter {
	if fullhw && f.version.Gteq(ffmpeg.Version{major: 3, minor: 3}) { // Added in FFMpeg 3.3
...
var _ codec.VideoCodec = (*Codec_hardware_i264c)(nil)
var _ codec.HardwareVideoCodec = (*Codec_hardware_i264c)(nil)
