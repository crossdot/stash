...
func (c *Codec_hardware_v264) HwApplyFullHWFilter(args ffmpeg.VideoFilter, fullhw bool) ffmpeg.VideoFilter {
	if fullhw && f.version.Gteq(ffmpeg.Version{major: 3, minor: 1}) { // Added in FFMpeg 3.1
...
var _ codec.VideoCodec = (*Codec_hardware_v264)(nil)
var _ codec.HardwareVideoCodec = (*Codec_hardware_v264)(nil)
