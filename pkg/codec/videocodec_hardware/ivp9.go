...
func (c *Codec_hardware_ivp9) hwApplyFullHWFilter(args VideoFilter, fullhw bool) VideoFilter {
...
// Switch scaler
func (c *Codec_hardware_ivp9) hwApplyScaleTemplate(sargs string, match []int, vf *models.VideoFile, fullhw bool) VideoFilter {
	var template string
